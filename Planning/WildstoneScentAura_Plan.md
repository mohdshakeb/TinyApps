...
## Session-by-Session Plan (~13 sessions over 1 month)
...
**Session 10 — Bundle budget + load-perf pass**
...
**Session 11 — Edge-case hardening**
...
**Session 12 — Full demo rehearsal**
...
- **Session 12 (final):** the unaided cold run-through on an untested device is the actual acceptance test for the whole month of work — this is the condition that determines "ready for the client demo."
